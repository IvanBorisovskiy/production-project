...
- `npm run update:imports` - Скрипт для добавление alias к импортам
- `npm run shared:public:api` - Скрипт для создания public api в shared слое
----
...
используется eslint plugin *eslint-plugin-ulbi-tv-plugin*,
...
в него передается объект с опциями: 
   ...
   3. off: функция, которая отработает после выключения фичи
